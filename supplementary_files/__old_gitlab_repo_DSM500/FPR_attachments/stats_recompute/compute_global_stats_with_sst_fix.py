...
def main():
    ...
    if rank == 0:
        ...
        print(global_means)
        np.save(f"/iopsstor/scratch/cscs/stefschu/DSM500/gitlab/stats/global_means_with_sst_fix.npy", global_means.reshape(1, -1, 1, 1))
        print()
    ...
    # Compute stddev
    global_means = np.load(f"/iopsstor/scratch/cscs/stefschu/DSM500/gitlab/stats/global_means_with_sst_fix.npy")
    ...
    if rank == 0:
        ...
        np.save(f"/iopsstor/scratch/cscs/stefschu/DSM500/gitlab/stats/global_stds_with_sst_fix.npy", global_stddevs.reshape(1, -1, 1, 1))
