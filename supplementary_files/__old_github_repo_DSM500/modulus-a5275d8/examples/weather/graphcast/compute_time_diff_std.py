...
import modulus
import os
print(os.environ["SLURM_PROCID"], modulus.__file__)
...
def main(cfg: DictConfig) -> None:
    ...
    if dist.rank == 0:
        ...
        np.save("time_diff_std_new_t2m.npy", std.to(torch.device("cpu")).numpy())
        np.save("time_diff_mean_new_t2m.npy", mean.to(torch.device("cpu")).numpy())
