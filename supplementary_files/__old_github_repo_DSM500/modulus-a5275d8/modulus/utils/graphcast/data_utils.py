...
class StaticData:
    ...
    def get_lat_lon(self) -> Tensor:  # pragma: no cover
        ...
        # normalize
        cos_lat_mg = (cos_lat_mg - cos_lat_mg.mean()) / cos_lat_mg.std()
        ...
        # normalize
        sin_lon_mg = (sin_lon_mg - sin_lon_mg.mean()) / sin_lon_mg.std()
        ...
        # normalize
        cos_lon_mg = (cos_lon_mg - cos_lon_mg.mean()) / cos_lon_mg.std()
