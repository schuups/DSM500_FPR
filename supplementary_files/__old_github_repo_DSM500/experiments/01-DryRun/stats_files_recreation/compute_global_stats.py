...
def main():
    ...
    if rank == 0:
        ...
        np.save(f"/iopsstor/scratch/cscs/stefschu/DSM500/github/experiments/01-DryRun/stats_files_recreation/global_means_with_sst_fix_t2m.npy", global_means)
        print()
    ...
    # Compute stddev
    global_means = np.load(f"/iopsstor/scratch/cscs/stefschu/DSM500/github/experiments/01-DryRun/stats_files_recreation/global_means_with_sst_fix_t2m.npy")
    ...
    if rank == 0:
        ...
        np.save(f"/iopsstor/scratch/cscs/stefschu/DSM500/github/experiments/01-DryRun/stats_files_recreation/global_stds_with_sst_fix_t2m.npy", global_stddevs)
